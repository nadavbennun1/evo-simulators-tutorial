(() => {
  ...
  function diversityPredictionLab() {
    ...
    function drawProcess() {
      ...
      const headings = ["ONE INFERRED EXPLANATION", "SIMULATE TO GENERATION G", "AT GENERATION t, NEW LINEAGES FORM", "EVOLVE EACH COHORT TO G", "CALCULATE DIVERSITY AT G"];
