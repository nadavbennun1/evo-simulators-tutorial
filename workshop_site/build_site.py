...
def landing_page() -> str:
    ...
    <section class="chapter-cards" aria-label="Choose a lesson"><a href="evolution.html"><span>Chapter 01</span><h2>Evolutionary simulators</h2><p>Mechanistic models of allele-frequency change.</p><small>75 min · 15 min foundations + 60 min lesson</small><strong>Open lesson</strong></a><a href="sbi.html"><span>Chapter 02</span><h2>Simulation-based inference</h2><p>Posterior inference from stochastic simulators.</p><small>75 min · 15 min foundations + 60 min lesson</small><strong>Open lesson</strong></a></section>
