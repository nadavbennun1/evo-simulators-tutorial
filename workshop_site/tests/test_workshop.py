...
def test_chapter_one_revision_contract():
    ...
    assert text.index('id="avecilla-model-builder"') < text.index('id="evolution-playground"')
    assert text.index('id="evolution-playground"') < text.index('data-cell-id="6ec896e6"')
    assert text.index('data-cell-id="6ec896e6"') < text.index('data-cell-id="d29cac1e"') < text.index('id="effective-population-size"')
    assert text.index('id="effective-population-size"') < text.index('alt="Researchers celebrate agreement between continuous chemostat and Wright–Fisher simulations"')
