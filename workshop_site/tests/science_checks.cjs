...
const fineGridLogEpsilon=science.estimateCollectiveLogEpsilon(lab,allIndices,1,.95,41);
...
const jointFineGrid=science.collectiveJointSelectionMarginals(lab,allIndices,1,estimatedLogEpsilon,41);
...
process.stdout.write(JSON.stringify({output,avecilla,chuong,score,odd,even,collective,robustLoose,robustTight,estimatedLogEpsilon,fineGridLogEpsilon,epsilonReproducible,neutralContaminantMean,fullContaminantMean,jointEstimated,jointFixed,jointClean,jointLowContamination,jointHighContamination,jointFineGrid,reproducible}));
