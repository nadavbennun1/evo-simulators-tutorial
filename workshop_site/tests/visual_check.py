...
def main() -> None:
    ...
    try:
        ...
        equation_steps = driver.find_element("css selector", ".diversity-equation-steps")
        driver.execute_script("arguments[0].scrollIntoView({block:'start'})", equation_steps)
        equation_steps.screenshot("/tmp/workshop-diversity-equations.png")
